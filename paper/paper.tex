...
\begin{abstract}
  ...
  using a realisability technique due to Dal Lago and Hofmann.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Affine Linear $\lambda$-Calculus and Polytime}
...
$\mathrm{Tape}$ type as a Zipper \cite{huet}
...
pattern-matching elimination. See \cite{atkey18qtt} for details.
...
polytime programs. For example, insertion of a natural into a sorted
list:
\begin{displaymath}
...
well known in dependent type theory \cite{abbott03categories}, and
speaks to a general conception of containers as ``problem/solution''
pairings.
...
\begin{displaymath}
  \mathrm{NP}(A,P) =
  \begin{array}[t]{l}
    (f \stackrel1: \mathbf{R}(A \multimap \mathrm{ND}(\BoolTy)))\, \otimes \\
...
\begin{displaymath}
  \mathrm{PP}(A,P) =
  \begin{array}[t]{l}
    (f \stackrel1: \mathbf{R}(A \multimap \mathrm{Dist}(\BoolTy))) \, \otimes
...
The ones from Fossacs 2022, and POPL23(?) Romain Perchoux
