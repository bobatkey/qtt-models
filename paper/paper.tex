...
Probabilistic Polynomial time \cite{aurora}, we use a (non-iterable)
data structure representing trees of probabilistic choices, where
$\mathbb{Q}[0,1]$ is some type of (non-iterable) rationals in the
closed interval $[0,1]$:
\begin{displaymath}
  \begin{array}{l}
...
semantic nature \cite{aurora}, where the correctness of implementation
is probabilistic. With a dependently-typed host language, adding
