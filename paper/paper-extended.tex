...
The Agda source files and rendered HTML for this paper is available from Zenodo \cite{atkey2023polydep-artefact}. The source files are also available online at GitHub: \url{https://github.com/bobatkey/qtt-models}, commit SHA1
